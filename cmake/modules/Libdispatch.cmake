...
foreach(sdk ${DISPATCH_SDKS})
  ...
  foreach(arch ${ARCHS})
    ...
    if(sdk MATCHES WINDOWS OR sdk MATCHES LINUX)
    ...
    # If we are cross-compiling with a sysroot, set CMAKE_SYSROOT, target, and use lld
    if(sdk MATCHES LINUX AND CROSS_COMPILE_DEPS_PATH)
      set(CMAKE_SYSROOT ${CROSS_COMPILE_DEPS_PATH})
      set(SWIFT_LIBDISPATCH_COMPILER_TRIPLE_CMAKE_ARGS -DCMAKE_C_COMPILER_TARGET=${SWIFT_SDK_LINUX_ARCH_${arch}_TRIPLE};-DCMAKE_CXX_COMPILER_TARGET=${SWIFT_SDK_LINUX_ARCH_${arch}_TRIPLE})
      set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -w -fuse-ld=lld")
      set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -w -fuse-ld=lld")
    endif()
